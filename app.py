...
<head>
    ...
    <style>
        ...
        .line { position: absolute; top: 0; left: 0; width: 100%; height: 3px; background: #00ff88; box-shadow: 0 0 15px #00ff88; }
...
<body>
    ...
    <div class="card">
        <div class="line"></div>
        <h1>LOSPASH</h1>
        <div class="avatar-box"><img id="head" src="" class="avatar" style="display:none"></div>
        <div id="username" class="username">Spieler</div>
        <div id="status" class="status">Initialisiere...</div>
        <button id="btn" class="btn" onclick="go()">Lade...</button>
    </div>
    <script>
        const params = new URLSearchParams(window.location.search);
        let ign = params.get('name') || params.get('ign');
        let imgName = ign;
